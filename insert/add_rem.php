...
$row = mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM tbl_admission where enrollment_no =$vid1"));
?>
...
<head>
    ...
    <!-- ===============================================--><!--    Document Title--><!-- ===============================================-->
    <title>PSIT Reminder | Dashboard &amp; Web App Template</title>
            ...
            <form action="insert_records.php" method="post">
              <div class="row flex-between-center">
                ...
                <div class="col-auto">
                  ...
                  <input type="submit" class="btn btn-primary" name="insert_fees_reminder" role="button" value="Add Reminder">
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="card-body pt-0">
                  ...
                  <div class="row gx-2">
                      <div class="col-2 mb-2">
                        ...
                        <input class="form-control" name="rem_amount" id="product-name" type="rem_amount"/>
                      </div>
                  
                     
                      <div class="col-2 mb-2">
                        <label class="form-label" for="manufacturar-name">Reminder Date:</label>
                        <input class="form-control datetimepicker" id="start-date" type="text" name="rem_date" placeholder="dd/mm/yy" data-options='{"dateFormat":"Y-m-d","disableMobile":true}' />
                      </div>
                      <div class="col-2 mb-2">
