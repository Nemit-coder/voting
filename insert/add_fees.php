...
$row = mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM tbl_student_fees where enrollment_no =$vid1 order by id desc"));
?>
                ...
                <div class="card-body pt-0">
                  ...
                  <div class="row gx-2">
                      ...
                      <div class="col-2 mb-2">
                        ...
                        <input class="form-control" id="product-name" name="course_fee" type="number" value="<?php echo $row['pending_fee'];?>" readonly/>
                      </div>
                      <div class="col-2 mb-2">
