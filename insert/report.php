<div class="content">
          ...
          <div class="card mb-3">
            <div class="card-body">
            <form action="<?php echo BASE_URL?>repo/today.php" method="POST">
              <div class="row flex-between-center">
                <div class="col-md">
                  <h5 class="mb-2 mb-md-0">Select Date for report</h5>
                </div>
                <div class="col-auto">
                    <input type="submit" class="btn btn-primary" name="report" role="button" value="Generate Student Report">
                  <input type="submit" class="btn btn-primary" name="report" role="button" value="Generate Report">
              </div>
              </div>
            </div>
          </div>
