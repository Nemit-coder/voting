...
<?php
$vid=base64_decode($_GET['svdsfsdffwerwhrgngfnghjsewrwrghgngfn']);
          ...
          <div class="card mb-3">
            ...
            <form action="insert_records.php" method="post">
              <div class="row flex-between-center">
                <div class="col-md">
                  <h5 class="mb-2 mb-md-0"><?php echo $row['enrollment_no'];?> | Add Fees Details</h5>
                </div>
                <div class="col-auto">
                ...
                <div class="card-body pt-0">
                  ...
                  <div class="row gx-2">
                      ...
                      <div class="col-2 mb-2">
                        ...
                        <input class="form-control" id="product-name" name="course_fee" type="number"/>
                      </div>
                      <div class="col-2 mb-2">
