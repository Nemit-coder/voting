...
if(isset($_POST['register'])){
    ...
    if($numRows > 0){
        ...
        echo "<script>window.open('client_register.php','_self')</script>";
    }
                  ...
                  <div class="col-md-7 d-flex flex-center">
                    <div class="p-4 p-md-5 flex-grow-1">
                      ...
                      <form action="<?php $_SERVER["PHP_SELF"]; ?>" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="card-password">Created by</label>
                        <select class="form-control" name="" id="" disabled>
                            <?php
                            $sql = "select * from tbl_admin_login where status = '1'";
                            $result = mysqli_query($conn, $sql);
