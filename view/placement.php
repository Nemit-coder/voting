                  ...
                  <div class="d-lg-flex justify-content-between">
                    <div class="row flex-between-center gy-2 px-x1">
                      <div class="col-auto pe-0">
                        <h6 class="mb-0">All Placed Student</h6>
                      </div>
                      <div class="col-auto">
                        <form>
                    ...
                    <table class="table table-sm mb-0 fs-10 table-view-tickets text-center">
                      <thead class="bg-body-tertiary">
                        ...
                        <th class="text-800 sort align-middle" data-sort="name">Date</th>
                          ...
                          <th class="text-800 sort align-middle" data-sort="name">Company Name</th>
                          
                          <th class="text-800 sort align-middle" data-sort="course">Designation</th>
                          <th class="text-800 sort align-middle" data-sort="phone">Salary</th>
                          <th class="text-800 sort align-middle" data-sort="phone">Remarks</th>
                        </tr>
                      </thead>
                      ...
                      <tr>
                        ...
                        <td class="align-middle er py-2 pe-3"><b><?php echo date("d-m-Y", strtotime($row["date"])); ?></b></td>
                        
                        <td class="align-middle er py-2 pe-3"><b><?php echo $row["student_name"]; ?></b></td>
                        <td class="align-middle name py-2 pe-2"><?php echo $row["company_name"]; ?></td>
                        <td class="align-middle name py-2 pe-2"><?php echo $row["designation"]; ?></td>
                        <td class="align-middle name py-2 pe-2"><?php echo $row["salary"]; ?></td>
                        <td class="align-middle name py-2 pe-2"><?php echo $row["remarks"]; ?></td>
