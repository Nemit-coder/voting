          ...
          <div class="collapse navbar-collapse scrollbar" id="navbarStandard" style="margin-left:150px">
            <ul class="navbar-nav" data-top-nav-dropdowns="data-top-nav-dropdowns">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" href="<?php echo BASE_URL?>view/view.php?VxjMWVHUlhiSGxsVVQwOQ=<?php echo base64_encode(base64_encode(base64_encode('enquiry')));?>" role="button"  aria-haspopup="true" aria-expanded="false">Enquiry</a>
              </li>
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-caret dropdown-menu-card border-0 mt-0" aria-labelledby="dashboards">
                  <div class="bg-white dark__bg-1000 rounded-3 py-2">
                    ...
                    <a class="dropdown-item link-600 fw-medium" href="<?php echo BASE_URL?>view/view.php?VxjMWVHUlhiSGxsVVQwOQ=<?php echo base64_encode(base64_encode(base64_encode('student_documents')));?>">Document</a>           
                             <a class="dropdown-item link-600 fw-medium" href="<?php echo BASE_URL?>view/view.php?VxjMWVHUlhiSGxsVVQwOQ=<?php echo base64_encode(base64_encode(base64_encode('Fees_reminder')));?>">Fees Reminder</a>      </div>
                </div>
              </li>
