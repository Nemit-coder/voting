                ...
                <div class="card-header border-bottom border-200 px-0">
                  <div class="d-lg-flex justify-content-between">
                    ...
                    <div class="d-flex align-items-center justify-content-between justify-content-lg-end px-x1">
                      ...
                      <a class="btn btn-falcon-default btn-sm mx-2" href="<?php echo BASE_URL?>insert/insert.php?VxjMWVHUlhiSGxsVVQwOQ=<?php echo base64_encode(base64_encode(base64_encode('add_batch')));?>"type="button">
                            <span class="fas fa-plus" data-fa-transform="shrink-3"></span>
                            <span class="d-none d-sm-inline-block ms-1">Add Batch</span>
        </a>
                    ...
                    <table class="table table-sm mb-0 fs-10 table-view-tickets text-center">
                      <thead class="bg-body-tertiary">
                        ...
                        <th class="text-800 sort align-middle" data-sort="no">No</th>
                          ...
                          <th class="text-800 sort align-middle" data-sort="date">Module</th>
                      ...
                      <tr>
                        ...
                        <td class="align-middle name py-2 pe-2"><?php echo $row["batch_time"]; ?></td>
                         <td class="align-middle phone py-2 pe-2"><?php echo $row["employee_name"]; ?></td>
                        <td class="align-middle course py-2 pe-4"><?php echo date("d-m-Y", strtotime($row["start_batch_date"])); ?>&nbsp;&nbsp;/&nbsp;&nbsp;<?php echo date("d-m-Y", strtotime($row["end_batch_date"])) ?></td>
                        ...
                        ?></td> 
                        <td>
                          <a class="btn btn-falcon-default btn-sm mb-sm-0" href="bdetails.php?xsVVQwOQlhiSxjMWVHUlhiS=<?php echo base64_encode(base64_encode(base64_encode($row['id'])));?>" type="button">
