                  ...
                  <div class="d-lg-flex justify-content-between">
                    <div class="row flex-between-center gy-2 px-x1">
                      <div class="col-auto pe-0">
                        <h6 class="mb-0">All Admission</h6>
                      </div>
                      <div class="col-auto">
                        <form>
                    ...
                    <div class="d-flex align-items-center justify-content-between justify-content-lg-end px-x1">
                      ...
                      <a class="btn btn-falcon-default btn-sm mx-2" href="<?php echo BASE_URL?>insert/insert.php?VxjMWVHUlhiSGxsVVQwOQ=<?php echo base64_encode(base64_encode(base64_encode('add_admission')));?>"type="button">
                            <span class="fas fa-plus" data-fa-transform="shrink-3"></span>
                            <span class="d-none d-sm-inline-block ms-1">Add Admission</span>
        </a>
                    ...
                    <table class="table table-sm mb-0 fs-10 table-view-tickets text-center">
                      <thead class="bg-body-tertiary">
                        ...
                        <th class="text-800 sort align-middle" data-sort="no">No</th>
                          ...
                          <th class="text-800 sort align-middle" data-sort="er">Enrollment</th>
                          <th class="text-800 sort align-middle" data-sort="name">Name</th>
                          <th class="text-800 sort align-middle" data-sort="phone">Phone</th>
                          <th class="text-800 sort align-middle" data-sort="course">Course</th>
                      ...
                      <tr>
                        ...
                        <td class="align-middle date py-2 pe-2"><?php echo date("d-m-Y", strtotime($row["date"])); ?></td>
                        <td class="align-middle er py-2 pe-3"><b><?php echo $row["enrollment_no"]; ?></b></td>
                        <td class="align-middle name py-2 pe-2"><?php echo $row["student_name"]; ?></td>
                         <td class="align-middle phone py-2 pe-2"><?php echo $row["phone_no"]; ?></td>
                        <td class="align-middle course py-2 pe-4"><?php echo $row["course_name"]; ?></td>
                        <td class="align-middle counsellor py-2 pe-4"><?php echo $row["counsellor"]; ?></td> 
                        <td>
                          <a class="btn btn-falcon-default btn-sm mb-sm-0" href="profile.php?viewid=<?php echo base64_encode(base64_encode(base64_encode($row['enrollment_no'])));?>" type="button">
