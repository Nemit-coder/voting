                ...
                <div class="card-header border-bottom border-200 px-0">
                  <div class="d-lg-flex justify-content-between">
                    ...
                    <div class="d-flex align-items-center justify-content-between justify-content-lg-end px-x1">
                      ...
                      <a class="btn btn-falcon-default btn-sm mx-2" href="<?php echo BASE_URL?>insert/insert.php?VxjMWVHUlhiSGxsVVQwOQ=<?php echo base64_encode(base64_encode(base64_encode('add_staff')));?>"type="button">
                  ...
                  <div class="table-responsive scrollbar">
                    ...
                    <table class="table table-sm mb-0 fs-10 table-view-tickets text-center">
                      <thead class="bg-body-tertiary">
                        ...
                        <th class="text-800 sort align-middle" data-sort="no">No</th>
                          ...
                          <th class="text-800 sort align-middle" data-sort="name">Emplyee Name</th>
                          
                          <th class="text-800 sort align-middle" data-sort="course">Designation</th>
                          <th class="text-800 sort align-middle" data-sort="phone">Contact</th>
                          <th class="text-800 sort align-middle" data-sort="counsellor">Email</th>
                    ...
                    ?>  
                      <tr>
                        ...
                        <td class="align-middle no py-2 pe-14"><?php echo $id = htmlspecialchars($id,ENT_QUOTES,'UTF-8');  ?></td>
                        
                        <td class="align-middle er py-2 pe-3"><b><?php echo $employee_name = htmlspecialchars($employee_name,ENT_QUOTES,'UTF-8'); ?></b></td>
                        <td class="align-middle name py-2 pe-2"><?php echo $designation = htmlspecialchars($designation,ENT_QUOTES,'UTF-8'); ?></td>
                        <td class="align-middle name py-2 pe-2"><?php echo $contact_no = htmlspecialchars($contact_no,ENT_QUOTES,'UTF-8'); ?></td>
                         <td class="align-middle phone py-2 pe-2"><?php echo $email = htmlspecialchars($email,ENT_QUOTES,'UTF-8'); ?></td>
                       <td class="align-middle counsellor py-2 pe-4">
                        ...
                        ?></td> 
                        <td>
                          <a class="btn btn-falcon-default btn-sm mb-sm-0" href="update_status.php?staff_disable_id=<?php echo base64_encode($id);?>" type="button">
                              <span class="fas fa-eye me-1"> </span>
        </a>  <a class="btn btn-falcon-default btn-sm mb-sm-0" href="update_status.php?staff_disable_id=<?php echo base64_encode($id);?>" type="button">
                    ...
                    <div class="text-center d-none" id="tickets-table-fallback">
                      <p class="fw-bold fs-8 mt-3">No Staff Members found</p>
                    </div>
                  </div>
                </div>
