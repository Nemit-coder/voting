                ...
                <div class="card-header border-bottom border-200 px-0">
                  <div class="d-lg-flex justify-content-between">
                    ...
                    <div class="d-flex align-items-center justify-content-between justify-content-lg-end px-x1">
                      ...
                      <a class="btn btn-falcon-default btn-sm mx-2" href="<?php echo BASE_URL?>insert/insert.php?VxjMWVHUlhiSGxsVVQwOQ=<?php echo base64_encode(base64_encode(base64_encode('add_course')));?>"type="button">
                            <span class="fas fa-plus" data-fa-transform="shrink-3"></span>
                            <span class="d-none d-sm-inline-block ms-1">Add Course</span>
        </a>
                  ...
                  <div class="table-responsive scrollbar">
                    ...
                    <table class="table table-sm mb-0 fs-10 table-view-tickets text-center">
                      <thead class="bg-body-tertiary">
                        ...
                        <th class="text-800 sort align-middle" data-sort="no">No</th>
                          ...
                          <th class="text-800 sort align-middle" data-sort="name">Course Name</th>
                          
                          <th class="text-800 sort align-middle" data-sort="course">Fee</th>
                          <th class="text-800 sort align-middle" data-sort="phone">Duration</th>
                          <th class="text-800 sort align-middle" data-sort="counsellor">Certificate</th>
                    ...
                    ?>  
                      <tr>
                        ...
                        <td class="align-middle er py-2 pe-3"><b><?php echo $course_name = htmlspecialchars($course_name,ENT_QUOTES,'UTF-8');; ?></b></td>
                        <td class="align-middle name py-2 pe-2"><?php echo $course_duration; ?></td>
                         <td class="align-middle phone py-2 pe-2"><?php echo $course_fee; ?></td>
                        <td class="align-middle course py-2 pe-4"><?php echo $certificate; ?></td>
