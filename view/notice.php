               ...
               <div class="card-header border-bottom border-200 px-0">
                 <div class="d-lg-flex justify-content-between">
                   ...
                   <div class="d-flex align-items-center justify-content-between justify-content-lg-end px-x1">
                     ...
                     <a class="btn btn-falcon-default btn-sm mx-2" href="<?php echo BASE_URL?>insert/insert.php?VxjMWVHUlhiSGxsVVQwOQ=<?php echo base64_encode(base64_encode(base64_encode('add_notice')));?>"type="button">
                           <span class="fas fa-plus" data-fa-transform="shrink-3"></span>
                           <span class="d-none d-sm-inline-block ms-1">Add Notice</span>
       </a>
                   ...
                   <table class="table table-sm mb-0 fs-10 table-view-tickets text-center">
                     <thead class="bg-body-tertiary">
                       ...
                       <th class="text-800 sort align-middle" data-sort="name">Date</th>
                         <th class="text-800 sort align-middle" data-sort="date">Category</th>
                         <th class="text-800 sort align-middle" data-sort="er">File</th>
                     ...
                     <tr>
                       ...
                       <td class="align-middle no py-2 pe-14"><?php echo date("d-m-Y", strtotime($row["date"])); ?></td>
                       
                       <td class="align-middle er py-2 pe-3"><b><?php echo $row["category"]; ?></b></td>
                       <td class="align-middle name py-2 pe-2"><a href="../documents/notice/<?php echo $row["stat_file"]; ?>" target="_blank">  <div class="badge rounded-pill badge-subtle-success fs-11">Click Here
