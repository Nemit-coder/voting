                  ...
                  <div class="d-lg-flex justify-content-between">
                    <div class="row flex-between-center gy-2 px-x1">
                      <div class="col-auto pe-0">
                        <h6 class="mb-0">All student documents</h6>
                      </div>
                      <div class="col-auto">
                        <form>
                    ...
                    <div class="d-flex align-items-center justify-content-between justify-content-lg-end px-x1">
                      ...
                      <a class="btn btn-falcon-default btn-sm mx-2" href="<?php echo BASE_URL?>insert/insert.php?VxjMWVHUlhiSGxsVVQwOQ=<?php echo base64_encode(base64_encode(base64_encode('add_doc')));?>"type="button">
                            ...
                            <span class="d-none d-sm-inline-block ms-1">Add Docuement</span>
        </a>
                    ...
                    <table class="table table-sm mb-0 fs-10 table-view-tickets text-center">
                      <thead class="bg-body-tertiary">
                        ...
                        <th class="text-800 sort align-middle" data-sort="name">Student Name</th>
                          ...
                          <th class="text-800 sort align-middle" data-sort="name">Image</th>
                      ...
                      <tr>
                        ...
                        <td class="align-middle name py-2 pe-2"><img src="<?php echo BASE_URL?>insert/uploads/<?php echo $row["enrollment_no"];?>/<?php echo $row["stat_file"]; ?>" height="50" width="50"></td>
